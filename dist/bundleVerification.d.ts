 ...
 */
import { TrustPolicy, type AttestationKeyRecord, type PortableBundle, type TrustPolicyOptions, type VerificationReport } from '@onchaindiligence/agent-evidence';
 ...
 */
export declare function verifyBundleOffline(bundle: string | Uint8Array | PortableBundle | Record<string, unknown>, trust: OfflineBundleTrust, options?: OfflineBundleVerificationOptions): OfflineBundleVerificationReport;
